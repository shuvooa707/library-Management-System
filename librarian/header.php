...
$libaraian_email = $_SESSION['libraian_login'];

$query = "SELECT * FROM libraian WHERE email = '$libaraian_email'";
$result = mysqli_query($db, $query);
if(mysqli_num_rows($result) > 0 ){
    $libaraian_info = mysqli_fetch_assoc($result);
}
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucfirst($libaraian_info['first_name']); ?></span>
