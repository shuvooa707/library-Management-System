                    ...
                    <div class="table-responsive">
                        <table id="basic-table" class="data-table table-bordered table table-striped nowrap table-hover" cellspacing="0" width="100%">
                            ...
                            <tbody>
                              ...
                              $result = mysqli_query($db, "SELECT issue_book.book_issue_date, books.book_name, books.book_image FROM books
                              INNER JOIN issue_book ON issue_book.book_id = books.id WHERE issue_book.student_id = '$student_id'");
                                ...
                                <tr>
                                    <td><?= $row['book_name']; ?></td>
                                    <td><img src="../images/books/<?= $row['book_image']; ?>" style="height:100px;" alt=""></td>
